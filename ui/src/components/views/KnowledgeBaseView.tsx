...
const KnowledgeBaseView: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "deviceName",
      width: 180,
      render: (deviceName: string | undefined) =>
        deviceName || <Text type="secondary">-</Text>,
    },
    {
      title: "采样率",
      ...
      key: "sampleRate",
      width: 140,
      render: (sampleRate: number | undefined) =>
        sampleRate ? `${sampleRate} Hz` : <Text type="secondary">-</Text>,
    },
    {
      title: "大小",
      dataIndex: "size",
